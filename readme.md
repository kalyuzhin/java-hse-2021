...
#### Блок для должников
Блок, который необходимо сдать на полный балл всем, кто не набрал `50` баллов за первые три блока контеста для получения оценки.
...
**Внимание: Для успешного прохождения курса, студент должен получить как минимум `50` баллов за первые три блока контеста, либо решить блок контеста для должников на полный балл.**
